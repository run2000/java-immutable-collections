...
public final class TestImmutableSortedArrayMap {
    ...
    public void testBuilder() throws Exception {
      ImmutableSortedArrayMap<String, String> map =
        ...
        Assert.assertEquals("1", values.getAtIndex(0));
        Assert.assertEquals("2", values.getAtIndex(1));
        Assert.assertEquals("3", values.getAtIndex(2));
        Assert.assertEquals("4", values.getAtIndex(3));
        Assert.assertEquals("5", values.getAtIndex(4));
        Assert.assertEquals("7", values.getAtIndex(5));
        Assert.assertEquals("96", values.getAtIndex(6));

        Assert.assertEquals(0, values.indexOf("1"));
        Assert.assertEquals(1, values.indexOf("2"));
        Assert.assertEquals(2, values.indexOf("3"));
        Assert.assertEquals(3, values.indexOf("4"));
        Assert.assertEquals(4, values.indexOf("5"));
        Assert.assertEquals(5, values.indexOf("7"));
        Assert.assertEquals(6, values.indexOf("96"));

        Assert.assertEquals(-1, values.indexOfRange("1", 2, 7));
        Assert.assertEquals(-1, values.indexOfRange("2", 2, 7));
        Assert.assertEquals(2, values.indexOfRange("3", 2, 7));
        Assert.assertEquals(3, values.indexOfRange("4", 2, 7));
        Assert.assertEquals(4, values.indexOfRange("5", 2, 7));
        Assert.assertEquals(5, values.indexOfRange("7", 2, 7));
        Assert.assertEquals(6, values.indexOfRange("96", 2, 7));
        Assert.assertEquals(-1, values.indexOfRange(null, 2, 7));

        // toArray()
        arrAct = values.toArray();
        arrExp = new Object[] { "1", "2", "3", "4", "5", "7", "96" };
        Assert.assertArrayEquals(arrExp, arrAct);

        // toArray(String[]) -- three cases to consider
        arrAct1 = new String[6];
        arrExp1 = new String[] { "1", "2", "3", "4", "5", "7", "96" };
        ...
        arrExp3 = new String[] { "1", "2", "3", "4", "5", "7", "96", null };
        ...
        Assert.assertEquals("1:2:3:4:5:7:96", builder1.toString());
    ...
    public void testExceptions() throws Exception {
        ...
        ImmutableSortedArrayMap.emptyMap().clear();
