...
public final class TestImmutableHashedArrayBiMap {
    ...
    public void testEmptyMap() throws Exception {
        ImmutableHashedArrayMap<String, String> test = ImmutableHashedArrayMap.<String, String>builder().asBiMap().build();
    ...
    public void testSplitter() throws Exception {
        ...
        ImmutableHashedArrayMap<String, String> result1 =
                map1.entrySet().stream()
                        .filter(p -> p.getValue().charAt(1) != 'x')
                        .collect(Collectors.toImmutableHashedArrayBiMap());
        ...
        ImmutableHashedArrayMap<String, String> result2 =
    ...
    public void testKeySplitter() throws Exception {
        ImmutableHashedArrayMapBuilder<String, String> builder = ImmutableHashedArrayMapBuilder.newBiMap();
        builder.with("a", "ac");
        builder.with("b", "bc");
        builder.with("c", "cc");
        builder.with("e", "ec");
        ...
        ImmutableHashedArrayMap<String, String> result1 = builder.build();
    ...
    public void testCopyOf() throws Exception {
        ...
        ImmutableHashedArrayMap<String,String> result = ImmutableHashedArrayMap.copyOfBiMap(map1);
        ...
        ImmutableHashedArrayMap<String,String> result2 = ImmutableHashedArrayMap.copyOfBiMap(result);
        ...
        ImmutableHashedArrayMap<String,String> result4 = ImmutableHashedArrayMap.copyOf(result3);

        Assert.assertSame(result3, result4);

        ImmutableHashedArrayMap<String,String> result5 = ImmutableHashedArrayMap.copyOf(result2);
    ...
    public void testExceptions() throws Exception {
        ...
        ImmutableHashedArrayMap.emptyMap().clear();
