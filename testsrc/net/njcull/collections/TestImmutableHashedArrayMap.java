 ...
 * @version 8/01/2016.
 */
public final class TestImmutableHashedArrayMap {

    @Test
    public void testEmptyMap() throws Exception {
        ImmutableHashedArrayMap<String, String> test = ImmutableHashedArrayMap.<String, String>builder().build();
    ...
    public void testCollector() throws Exception {
        ...
        ImmutableHashedArrayMap<String, String> result =
                ...
                .collect(Collectors.toImmutableHashedArrayMap());
...
//        Assert.assertEquals("{a=ac, b=bc, c=cc, e=ec, f=fc, g=gc, m=0ma, n=0na, o=Zoa, p=Zpa}", result.toString());
    ...
    public void testKeySplitter() throws Exception {
        ImmutableHashedArrayMapBuilder<String, String> builder = new ImmutableHashedArrayMapBuilder<>();
        builder.with("a", "ac");
        builder.with("b", "bc");
        builder.with("c", "cc");
        builder.with("e", "ec");
    ...
    public void testSubMap() throws Exception {
        ...
        ImmutableHashedArrayMap<String, String> map = builder.build();
    ...
    public void testSerialization() throws Exception {
        ImmutableHashedArrayMap<String, Integer> map =
                ImmutableHashedArrayMap.<String, Integer>builder()
                        .with("c", 5, "d", 4, "e", 3)
                        .with("a", 7, "b", 96)
                        .with("f", 2, "g", 1).build();
