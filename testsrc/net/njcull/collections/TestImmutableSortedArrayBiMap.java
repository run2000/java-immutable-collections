...
public final class TestImmutableSortedArrayBiMap {
    ...
    public void testEmptyMap() throws Exception {
        ImmutableSortedArrayMap<String, String> test = ImmutableSortedArrayMap.<String, String>builder().asBiMap().build();
    ...
    public void testSerialization() throws Exception {
        ...
        ImmutableSortedArrayMap<String, Integer> map2 =
                (ImmutableSortedArrayMap<String, Integer>) ois.readObject();
        ...
        map2 = (ImmutableSortedArrayMap<String, Integer>) ois.readObject();
