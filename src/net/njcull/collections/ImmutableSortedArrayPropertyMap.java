...
public final class ImmutableSortedArrayPropertyMap<K,V> extends AbstractMap<K,V>
    ...
    /**
     * Returns an {@code ImmutableSortedArrayPropertyMap} that contains the values
     * supplied by the given {@code Iterable}, with keys generated by the given
     * supplier.
     * <p>
     * The returned map will have the keys sorted by their natural order.
     *
     * @param it the values to be copied
     * @param supplier the key generator, supplied by a value
     * @param <K> the key type of the map
     * @param <V> the value type of the map
     * @return an {@code ImmutableSortedArrayPropertyMap} containing the values
     * from the given {@code Iterable}, and keys from the given key supplier
     */
    @SuppressWarnings("unchecked")
    public static <K,V> ImmutableSortedArrayPropertyMap<K,V> copyOf(Iterable<? extends V> it, Function<? super V, ? extends K> supplier) {
        return new ImmutableSortedArrayPropertyMapBuilder<K,V>().with(it).byKeyMethod(supplier).build();
    }

    /**
     * Returns an {@code ImmutableSortedArrayPropertyMap} that contains the values
     * supplied by the given {@code Iterable}, with keys generated by the given
     * supplier, and keys ordered by the given {@code Comparator}.
     *
     * @param it the values to be copied
     * @param supplier the key generator, supplied by a value
     * @param cmp the comparator by which the keys will be sorted
     * @param <K> the key type of the map
     * @param <V> the value type of the map
     * @return an {@code ImmutableSortedArrayPropertyMap} containing the values
     * from the given {@code Iterable}, and keys from the given key supplier
     */
    @SuppressWarnings("unchecked")
    public static <K,V> ImmutableSortedArrayPropertyMap<K,V> copyOf(Iterable<? extends V> it,
            Function<? super V, ? extends K> supplier, Comparator<? super K> cmp) {
        return new ImmutableSortedArrayPropertyMapBuilder<K,V>().with(it).byComparingKeys(cmp).byKeyMethod(supplier).build();
    }
